package de.vogella2.android.todos.contentprovider;
...
import de.vogella2.android.todos.database.TodoDatabaseHelper;
...
public class MyTodoContentProvider extends ContentProvider {
    ...
    // Codes used for UriMatcher
    private static final int TODOS = 10;
    private static final int TODO_ID = 20;

    private static final String AUTHORITY = "de.vogella2.android.todos.contentprovider";
    private static final String BASE_PATH = "todos";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + BASE_PATH);
    // content://de.vogella.android.todos.contentprovider/todos
    ...
    // the third arg is the code that is returned when a URI is matched against the given components.
    static {
